...
HelperCmakeProject::HelperCmakeProject(string_par binary_dir)
    ...
    , build_script_add_pkg_out_file(cfg.cmakex_tmp_dir() + "/" + k_build_script_add_pkg_out_filename)
    , build_script_cmakex_out_file(cfg.cmakex_tmp_dir() + "/" + k_build_script_cmakex_out_filename)
{
}

void HelperCmakeProject::configure(const vector<string>& global_cmake_args, const cmakex_cache_t& cmakex_cache)
{
